 ...
 * header logo, the favicon, the federation badge, and the placeholder posts
 * fall back to. Nothing in the CMS points at them, hence the lookup by name.
 *
 ...
 */
export const SITE_ASSET_FILENAMES = ['logo.webp', 'favicon', 'federation', 'post_placeholder']
