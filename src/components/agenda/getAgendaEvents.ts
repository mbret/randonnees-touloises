...
import { dayInFrance, todayInFrance } from './groupOutings'
 ...
 * `groupOutingsByMonth` applies the exact cutoff on the `YYYY-MM-DD` strings,
 ...
 */
export const getAgendaEvents = async (): Promise<AgendaOuting[]> => {
